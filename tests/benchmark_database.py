...
from utils.database import store_embedding, db_client  # noqa: E402


def run_benchmark():
    # Setup
    collection_name = "benchmark_collection"
    # We use a larger number of iterations to make the collection lookup
    # overhead significant compared to cold start
    iterations = 200
